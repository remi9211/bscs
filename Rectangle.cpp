...
public:
	RectangleQ() {
		length = width = px1 = px2 = px3 = px4 = py1 = py2 = py3 = py4 = 1.0;
	}
	...
	void compute() {
		while(px1>20.0 && px1<0 || px2>20.0 && px2<0 || px3 > 20.0 && px3<0 || px4 > 20.0 && px4<0 || py1 > 20.0 && py1<0 || py2 > 20.0 && py2<0 || py3 > 20.0 && py3<0 || py4 > 20.0 && py4<0 ){
			if ( px1>20.0 ) {
...
int main() {
	RectangleQ rq(10,20,17,10,17,5,10,5);
	rq.isitrect();
	rq.compute();
	rq.display();
	rq.area();
